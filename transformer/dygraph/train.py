...
def do_train(args):
    ...
    with LogWriter(logdir="./log/low_"+str(mode)) as writer:
        # Train loop
        for pass_id in range(args.epoch):
            ...
            for input_data in train_loader:
                ...
                if step_idx % args.print_step == 0:
                    ...
                    writer.add_scalar(tag="train_avg_loss", step=step_idx, value=total_avg_cost)
                    writer.add_scalar(tag="train_normalized_loss", step=step_idx, value=total_avg_cost - loss_normalizer)
